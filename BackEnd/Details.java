...
public class Details {
    private LinkedList<SetOwn> sets;

    public Details() { sets = new LinkedList<>(); }
    public Details(SetOwn _sets) { sets = new LinkedList<>(); sets.add(_sets); }
    public Details(LinkedList<SetOwn> _sets) { sets = _sets; }

    public LinkedList<SetOwn> getSets() { return sets; }

    public void setSets(LinkedList<SetOwn> _sets) { sets = _sets; }

    public void addSets(SetOwn _sets) { sets.add(_sets); }
    public void addSets(LinkedList<SetOwn> _sets) { sets.addAll(_sets); }
